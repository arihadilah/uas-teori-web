			...
			<div class="row" style="flex-wrap: nowrap;">
				<div class="col-md-6 home-left-section">
					<div style="padding: 100px 0px; color: white;">
						...
						<hr>
						<p>
							Pesen Per-Mie-an disini aja, tanpa ribet tanpa antri, udah dijamin enak!
						</p>
				...
				<div class="col-md-4">
					<div class="our_qualities_column">
	                    ...
	                    <div class="caption">
	                        ...
	                        <p>
	                        	Menjaga kualitas makanan yang kami sajikan.
	                        </p>
	                    </div>
	                </div>
				</div>
				<div class="col-md-4">
					<div class="our_qualities_column">
	                    ...
	                    <div class="caption">
	                        ...
	                        <p>
	                        	Ingin makan enak ga perlu khawatir ngantri. Cukup reservasi dulu, lalu datang sesuai jadwal, lalu makan enak disini!
	                        </p>
	                    </div>
	                </div>
				</div>
				<div class="col-md-4">
					<div class="our_qualities_column">
	                    ...
	                    <div class="caption">
	                        ...
	                        <p>
	                        	Jika kamu mager keluar, kami akan mengantar makananmu dengan cepat.
	                        </p>
	                    </div>
	                </div>
				</div>
            ...
            <div class="row">
                <div class="col-lg-6 sm-padding">
                    <div class="contact-info">
                        ...
                        <p>
                            Restaurant Mie anti ribet anti ngantri!
                        </p>
                        <h3>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="footer_widget">
                        <img src="Design/images/MIESAN__2_-removebg-preview.png" alt="Restaurant Logo" style="width: 150px;margin-bottom: 20px;">
                        <p>
                            Restoran yang menyajikan aneka pilihan Menu Mie untuk mengganjal perutmu.
                        </p>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer_widget">
                        ...
                        <ul class="opening_time">
                            <li>Everyday 09:30am - 10:00pm</li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
